...
export class UsersListComponent implements OnInit {
 ...
 /*   getOtherUsers(): Array<User> {
        return this.users.filter(users.username !== this.username);
    }
*/
...
/*    initUserEvents() {
    ...
    subscribeToOtherUsers(users:any, username:any) {
        const filteredUsers: Array<any> = users.filter(username !== users.username);
